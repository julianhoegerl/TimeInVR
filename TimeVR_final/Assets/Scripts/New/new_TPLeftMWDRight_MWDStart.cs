...
public class new_TPLeftMWDRight_MWDStart : MonoBehaviour
{
    ...
    */
    ...
    IEnumerator waiter2()
    {
            ...
            switch (_spaceKeyCodeCounter)
            {
                ...
                case 57:
                    if (!(fixationCrossLeft.activeSelf || fixationCrossRight.activeSelf))
                    {
                        ...
                        numberIndex = arrowIndex = UnityEngine.Random.Range(0, screenLeftNumbers4.Length);
                        screenLeftNumbers4[numberIndex].SetActive(true);
        ...
        logger.writeMessageToLogGyroscope(id + ";" + condition + ";" + blockNumber + ";" + frameCounter + ";" + positionString + ";" + rotationString + ";" + Time.realtimeSinceStartup.ToString());
        frameCounter += 1;
    }
}