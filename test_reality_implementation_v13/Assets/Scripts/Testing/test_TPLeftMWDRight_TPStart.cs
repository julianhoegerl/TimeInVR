...
public class test_TPLeftMWDRight_TPStart : MonoBehaviour
{
    ...
    */
    ...
    void Start()
    {
        ...
        screenLeft = GameObject.Find("ScreenLeft");
        /*
        ...
        */
        ...
        screenRight = GameObject.Find("ScreenRight");
        /*
        ...
        */
        ...
        // left screens
        _screenLeftNumberA = GameObject.Find("CanvasLeft").transform.GetChild(0).gameObject;
        _screenLeftNumberB = GameObject.Find("CanvasLeft").transform.GetChild(1).gameObject;
        _screenLeftNumberC = GameObject.Find("CanvasLeft").transform.GetChild(2).gameObject;
        _screenLeftNumberD = GameObject.Find("CanvasLeft").transform.GetChild(3).gameObject;
        ...
        // fixation crosses
        fixationCrossRight = GameObject.Find("CanvasRight").transform.GetChild(4).gameObject;
        fixationCrossLeft = GameObject.Find("CanvasLeft").transform.GetChild(4).gameObject;
        
        
        //_screenLeftNumberA.gameObject.SetActive(false);
